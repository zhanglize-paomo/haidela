...
public class IndividualCustomerService {
    ...
    public Map<String, String> getSign(HttpServletRequest request, HttpServletResponse response) {
        ...
        Map<String, String> trnMap =  getTrnMap(request, publicKey);
    ...
    public Map<String, String> otherGetSign(HttpServletRequest request, HttpServletResponse response) {
        ...
        //对数据进行加密处理
        return encryptionMap(trnMap,sign);
    }
     ...
     * @return
     */
    private Map<String, String> encryptionMap(Map<String, String> trnMap, String sign) {
        Map<String, String> map = new HashMap<>();
        // 请求前对加密数据处理替换
        trnMap.put("sign",sign);
    ...
    private  Map<String, String> getTrnMap(HttpServletRequest request, String publicKey) {
        Map<String, String> trnMap = new HashMap<>();
